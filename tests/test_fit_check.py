                ...
                with patch('mkts_backend.cli_tools.fit_check._is_ship') as mock_is_ship:
                    with patch('mkts_backend.cli_tools.fit_check.get_equiv_stock') as mock_equiv:
                        with patch('mkts_backend.cli_tools.fit_check.fetch_jita_prices') as mock_jita:
                            ...
                            # No equivalents and no Jita prices for this test — it
                            # only asserts fits derived from marketstats.
                            mock_equiv.return_value = {}
                ...
                with patch('mkts_backend.cli_tools.fit_check._is_ship') as mock_is_ship:
                    with patch('mkts_backend.cli_tools.fit_check.get_equiv_stock') as mock_equiv:
                        with patch('mkts_backend.cli_tools.fit_check.fetch_jita_prices') as mock_jita:
                            ...
                            mock_is_ship.side_effect = lambda tid, cat, ctx: tid == 200
                            # No equivalents and no Jita prices for this test — it
                            # only asserts fit_price derived from marketstats.
                            mock_equiv.return_value = {}
                            mock_jita.return_value = {}
